...
--
-- Table structure for table `Client Laptops`
--
use mifostenant-default;

DROP TABLE IF EXISTS `Client Laptops`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Client Laptops` (
  ...
  CONSTRAINT `fk_client_laptops_client_id` FOREIGN KEY (`client_id`) REFERENCES `m_client` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=4 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Client Laptops`
--

LOCK TABLES `Client Laptops` WRITE;
/*!40000 ALTER TABLE `Client Laptops` DISABLE KEYS */;
INSERT INTO `Client Laptops` VALUES (1,1,'HP Elitebook 8740w','ASDFO903R2'),(2,1,'MacBook Pro 2018','OI9U98SDFSDF'),(3,2,'Lenove Thinkpad T430','POD98DFSFSDF');
/*!40000 ALTER TABLE `Client Laptops` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `Client Profile`
--

DROP TABLE IF EXISTS `Client Profile`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `Client Profile` (
  ...
  CONSTRAINT `fk_client_profile_client_id` FOREIGN KEY (`client_id`) REFERENCES `m_client` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `Client Profile`
--

LOCK TABLES `Client Profile` WRITE;
/*!40000 ALTER TABLE `Client Profile` DISABLE KEYS */;
INSERT INTO `Client Profile` VALUES (1,'',2),(2,'\0',0);
/*!40000 ALTER TABLE `Client Profile` ENABLE KEYS */;
UNLOCK TABLES;
...
INSERT INTO `job` VALUES (1,'Update loan Summary','Update loan Summary','0 0 22 1/1 * ? *','2014-03-07 18:29:14',5,NULL,'2014-06-11 09:30:00','2019-04-08 16:30:00','Update loan SummaryJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(2,'Update Loan Arrears Ageing','Update Loan Arrears Ageing','0 1 0 1/1 * ? *','2014-03-07 18:29:14',5,NULL,NULL,'2019-04-08 18:31:00','Update Loan Arrears AgeingJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(3,'Update Loan Paid In Advance','Update Loan Paid In Advance','0 5 0 1/1 * ? *','2014-03-07 18:29:14',5,NULL,NULL,'2019-04-08 18:35:00','Update Loan Paid In AdvanceJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(4,'Apply Annual Fee For Savings','Apply Annual Fee For Savings','0 20 22 1/1 * ? *','2014-03-07 18:29:14',5,NULL,'2014-06-11 09:50:00','2019-04-08 16:50:00','Apply Annual Fee For SavingsJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(5,'Apply Holidays To Loans','Apply Holidays To Loans','0 0 12 * * ?','2014-03-07 18:29:14',5,NULL,'2014-03-24 12:00:04','2019-04-09 06:30:00','Apply Holidays To LoansJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(6,'Post Interest For Savings','Post Interest For Savings','0 0 0 1/1 * ? *','2014-03-07 18:29:21',5,NULL,NULL,'2019-04-08 18:30:00','Post Interest For SavingsJobDetail1 _ DEFAULT',NULL,1,0,1,1,0),(7,'Transfer Fee For Loans From Savings','Transfer Fee For Loans From Savings','0 1 0 1/1 * ? *','2014-03-07 18:29:32',5,NULL,NULL,'2019-04-08 18:31:00','Transfer Fee For Loans From SavingsJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(8,'Pay Due Savings Charges','Pay Due Savings Charges','0 0 12 * * ?','2013-09-23 00:00:00',5,NULL,'2014-03-24 12:00:04','2019-04-09 06:30:00','Pay Due Savings ChargesJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(9,'Update Accounting Running Balances','Update Accounting Running Balances','0 1 0 1/1 * ? *','2014-03-07 18:29:37',5,NULL,NULL,'2019-04-08 18:31:00','Update Accounting Running BalancesJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(10,'Execute Standing Instruction','Execute Standing Instruction','0 0 0 1/1 * ? *','2014-05-01 16:10:35',5,NULL,NULL,'2019-04-08 18:30:00','Execute Standing InstructionJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(11,'Add Accrual Transactions','Add Accrual Transactions','0 1 0 1/1 * ? *','2014-05-01 16:10:36',3,NULL,NULL,'2019-04-08 18:31:00','Add Accrual TransactionsJobDetail1 _ DEFAULT',NULL,1,0,1,3,0),(12,'Apply penalty to overdue loans','Apply penalty to overdue loans','0 0 0 1/1 * ? *','2014-05-01 16:10:36',5,NULL,NULL,'2019-04-08 18:30:00','Apply penalty to overdue loansJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(13,'Update Non Performing Assets','Update Non Performing Assets','0 0 0 1/1 * ? *','2014-05-01 16:10:41',6,NULL,NULL,'2019-04-08 18:30:00','Update Non Performing AssetsJobDetail1 _ DEFAULT',NULL,1,0,1,3,0),(14,'Transfer Interest To Savings','Transfer Interest To Savings','0 2 0 1/1 * ? *','2014-06-11 09:09:15',4,NULL,NULL,'2019-04-08 18:32:00','Transfer Interest To SavingsJobDetail1 _ DEFAULT',NULL,1,0,1,1,0),(15,'Update Deposit Accounts Maturity details','Update Deposit Accounts Maturity details','0 0 0 1/1 * ? *','2014-06-11 09:09:15',5,NULL,NULL,'2019-04-08 18:30:00','Update Deposit Accounts Maturity detailsJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(16,'Add Periodic Accrual Transactions','Add Periodic Accrual Transactions','0 2 0 1/1 * ? *','2014-10-14 16:19:45',2,NULL,NULL,'2019-04-08 18:32:00','Add Periodic Accrual TransactionsJobDetail1 _ DEFAULT',NULL,1,0,1,3,0),(17,'Recalculate Interest For Loans','Recalculate Interest For Loans','0 1 0 1/1 * ? *','2014-10-14 16:19:55',4,NULL,NULL,'2019-04-08 18:31:00','Recalculate Interest For LoansJobDetail1 _ DEFAULT',NULL,1,0,1,3,0),(18,'Generate Mandatory Savings Schedule','Generate Mandatory Savings Schedule','0 5 0 1/1 * ? *','2015-04-16 02:28:43',5,NULL,NULL,'2019-04-08 18:35:00','Generate Mandatory Savings ScheduleJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(19,'Generate Loan Loss Provisioning','Generate Loan Loss Provisioning','0 0 0 1/1 * ? *','2015-10-20 19:57:58',5,NULL,NULL,'2019-04-08 18:30:00','Generate Loan Loss ProvisioningJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(20,'Post Dividends For Shares','Post Dividends For Shares','0 0 0 1/1 * ? *','2016-11-18 17:27:31',5,NULL,NULL,'2019-04-08 18:30:00','Post Dividends For SharesJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(21,'Update Savings Dormant Accounts','Update Savings Dormant Accounts','0 0 0 1/1 * ? *','2016-11-18 17:27:37',3,NULL,NULL,'2019-04-08 18:30:00','Update Savings Dormant AccountsJobDetail1 _ DEFAULT',NULL,1,0,1,1,0),(22,'Add Accrual Transactions For Loans With Income Posted As Transactions','Add Accrual Transactions For Loans With Income Posted As Transactions','0 1 0 1/1 * ? *','2016-11-18 17:27:42',5,NULL,NULL,'2019-04-08 18:31:00','Add Accrual Transactions For Loans With Income Posted As TransactionsJobDetail1 _ DEFAULT',NULL,1,0,1,3,0),(23,'Execute Report Mailing Jobs','Execute Report Mailing Jobs','0 0/15 * * * ?','2016-11-18 17:27:55',5,NULL,'2017-07-14 18:00:00','2019-04-08 12:15:00','Execute Report Mailing JobsJobDetail1 _ DEFAULT',NULL,1,0,1,0,0),(24,'Update SMS Outbound with Campaign Message','Update SMS Outbound with Campaign Message','0 0 5 1/1 * ? *','2016-11-18 17:28:01',3,NULL,NULL,'2019-04-08 23:30:00','Update SMS Outbound with Campaign MessageJobDetail1 _ DEFAULT',NULL,1,0,1,4,0),(25,'Send Messages to SMS Gateway','Send Messages to SMS Gateway','0 0 5 1/1 * ? *','2016-11-18 17:28:01',2,NULL,NULL,'2019-04-08 23:30:00','Send Messages to SMS GatewayJobDetail1 _ DEFAULT',NULL,1,0,1,4,0),(26,'Get Delivery Reports from SMS Gateway','Get Delivery Reports from SMS Gateway','0 0 5 1/1 * ? *','2016-11-18 17:28:01',1,NULL,NULL,'2019-04-08 23:30:00','Get Delivery Reports from SMS GatewayJobDetail1 _ DEFAULT',NULL,1,0,1,4,0);
...
INSERT INTO `m_appuser` VALUES (1,0,1,NULL,'fincore','App','Administrator','5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a','demomfi@fintecheando.mx','\0','','','','','2014-03-07',0,'\0'),(2,0,1,NULL,'adama','Adam','A','08a5c6ee6e7361aa153b4c8620d31bcedef514238a69c0f30f05fe460663cbc6','adama@123.com','\0','','','','','2014-03-07',0,'\0'),(4,0,2,NULL,'benb','Ben','B','19d327dc34e2f7b889b571ad9651355e8cce87493611847c70fabf1fcfa914c8','benb@123.com','\0','','','','','2014-03-07',0,'\0'),(5,0,3,NULL,'janej','Jane','J','f37ddcab2b9cfb015d94becdda719361ce13df943058cbf3130db468c288acb9','janej@123.com','\0','','','','','2014-03-07',0,'\0'),(6,0,1,NULL,'system','system','system','5787039480429368bf94732aacc771cd0a3ea02bcf504ffe1185ab94213bc63a','demomfi@fintecheando.mx','\0','','','','','2014-03-07',0,'\0');
...
INSERT INTO `m_charge` VALUES (1,'Processing Fee','USD',1,1,1,0,500.000000,NULL,NULL,NULL,0,1,0,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `m_client` VALUES (1,'000000001','22334455',300,NULL,'2014-03-07','2014-03-07',1,NULL,1,'Smith',NULL,'R',NULL,'Smith R','3655560252',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2010-01-01',1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(2,'000000002','11111111',300,NULL,'2010-01-04','2010-01-04',2,NULL,2,'Johnson',NULL,'D',NULL,'Johnson D','233717890222',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2010-01-04',1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'000000004',NULL,300,NULL,'2010-01-04','2010-01-04',2,NULL,2,'Williams',NULL,'G',NULL,'Williams G','255741000111',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2010-01-04',1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'000000005',NULL,300,NULL,'2010-01-04','2010-01-04',2,NULL,2,'Harris',NULL,'P',NULL,'Harris P','1212098765',0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2010-01-04',1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(6,'000000006','99999999',300,NULL,'2010-01-04','2010-01-04',2,NULL,2,'Allen',NULL,'E',NULL,'Allen E',NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2010-01-04',1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'000000007',NULL,300,NULL,'2010-01-04','2010-01-04',2,NULL,2,'Scott',NULL,'C',NULL,'Scott C',NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2010-01-04',1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,'000000008',NULL,300,NULL,'2010-01-04','2010-01-04',2,NULL,2,'Robinson',NULL,'R',NULL,'Robinson R',NULL,0,NULL,NULL,NULL,NULL,NULL,NULL,NULL,'2010-01-04',1,1,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `m_group` VALUES (1,NULL,300,'2010-01-02',2,2,NULL,1,'Santa Cruz','.1.',NULL,NULL,1,'2010-01-02',1,NULL,'000000001'),(2,NULL,300,'2010-01-03',2,2,NULL,1,'Santa Maria','.2.',NULL,NULL,1,'2010-01-03',1,NULL,'000000002'),(3,NULL,300,'2010-01-04',2,2,2,2,'Santa Maria Group 1','.2.3.',NULL,NULL,1,'2010-01-04',1,NULL,'000000003'),(4,NULL,300,'2010-01-04',2,2,2,2,'Santa Maria Group 2','.2.4.',NULL,NULL,1,'2010-01-04',1,NULL,'000000004');
...
INSERT INTO `m_office` VALUES (1,NULL,'.','1','Head Office','2009-01-01'),(2,1,'.2.',NULL,'Merida','2010-01-01'),(3,1,'.3.',NULL,'Guaymas','2010-02-08');
...
INSERT INTO `m_portfolio_command_source` VALUES (1,'CREATE','STAFF',1,NULL,NULL,NULL,NULL,'/staff/template',1,NULL,'{\"isLoanOfficer\":true,\"officeId\":1,\"firstname\":\"Aliya\",\"lastname\":\"A\"}',1,'2014-03-07 19:10:05',NULL,NULL,1,NULL,NULL,NULL,NULL),(2,'CREATE','USER',1,NULL,NULL,NULL,NULL,'/users/template',2,NULL,'{\"sendPasswordToEmail\":true,\"officeId\":1,\"username\":\"adama\",\"firstname\":\"Adam\",\"lastname\":\"A\",\"email\":\"adama@123.com\",\"roles\":[\"1\"]}',1,'2014-03-07 19:19:31',NULL,NULL,1,NULL,NULL,NULL,NULL),(3,'CREATE','CLIENT',1,NULL,1,NULL,NULL,'/clients/template',1,NULL,'{\"officeId\":1,\"staffId\":1,\"firstname\":\"Smith\",\"lastname\":\"R\",\"active\":true,\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\",\"activationDate\":\"07 March 2014\",\"submittedOnDate\":\"01 January 2010\",\"savingsProductId\":null}',1,'2014-03-07 19:23:36',NULL,NULL,1,NULL,NULL,NULL,NULL),(4,'CREATE','OFFICE',2,NULL,NULL,NULL,NULL,'/offices/template',2,NULL,'{\"parentId\":1,\"name\":\"Merida\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\",\"openingDate\":\"01 January 2010\"}',1,'2014-03-07 19:24:51',NULL,NULL,1,NULL,NULL,NULL,NULL),(5,'CREATE','USER',2,NULL,NULL,NULL,NULL,'/users/template',4,NULL,'{\"sendPasswordToEmail\":true,\"officeId\":2,\"username\":\"benb\",\"firstname\":\"Ben\",\"lastname\":\"B\",\"email\":\"benb@123.com\",\"roles\":[\"1\"]}',1,'2014-03-07 19:26:26',NULL,NULL,1,NULL,NULL,NULL,NULL),(6,'CREATE','STAFF',2,NULL,NULL,NULL,NULL,'/staff/template',2,NULL,'{\"isLoanOfficer\":true,\"officeId\":2,\"firstname\":\"Mary\",\"lastname\":\"M\"}',1,'2014-03-07 19:27:47',NULL,NULL,1,NULL,NULL,NULL,NULL),(7,'CREATE','CENTER',2,1,NULL,NULL,NULL,'/centers/template',1,NULL,'{\"officeId\":2,\"staffId\":2,\"active\":true,\"name\":\"Jimmy\",\"activationDate\":\"07 March 2014\",\"submittedOnDate\":\"02 January 2010\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2014-03-07 19:32:33',NULL,NULL,1,NULL,NULL,NULL,NULL),(8,'UPDATE','CENTER',2,1,NULL,NULL,NULL,'/centers/1',1,NULL,'{\"activationDate\":\"02 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\"}',1,'2014-03-07 19:32:55',NULL,NULL,1,NULL,NULL,NULL,NULL),(9,'CREATE','CENTER',2,2,NULL,NULL,NULL,'/centers/template',2,NULL,'{\"officeId\":2,\"name\":\"Global Trade Finance\",\"active\":true,\"activationDate\":\"07 March 2014\",\"submittedOnDate\":\"03 January 2010\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2014-03-07 19:41:08',NULL,NULL,1,NULL,NULL,NULL,NULL),(10,'UPDATE','CENTER',2,2,NULL,NULL,NULL,'/centers/2',2,NULL,'{\"staffId\":2,\"activationDate\":\"03 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\"}',1,'2014-03-07 19:41:40',NULL,NULL,1,NULL,NULL,NULL,NULL),(11,'CREATE','GROUP',2,3,NULL,NULL,NULL,'/groups/template',3,NULL,'{\"clientMembers\":[],\"staffId\":\"2\",\"name\":\"Nirvana\",\"active\":false,\"submittedOnDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"centerId\":\"2\",\"officeId\":\"2\"}',1,'2014-03-07 19:44:24',NULL,NULL,1,NULL,NULL,NULL,NULL),(12,'ACTIVATE','GROUP',2,3,NULL,NULL,NULL,'/groups/3?command=activate',3,NULL,'{\"activationDate\":\"04 January 2010\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2014-03-07 19:45:06',NULL,NULL,1,NULL,NULL,NULL,NULL),(13,'CREATE','GROUP',2,4,NULL,NULL,NULL,'/groups/template',4,NULL,'{\"clientMembers\":[],\"staffId\":\"2\",\"name\":\"Oasis\",\"active\":true,\"activationDate\":\"04 January 2010\",\"submittedOnDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"centerId\":\"2\",\"officeId\":\"2\"}',1,'2014-03-07 19:51:14',NULL,NULL,1,NULL,NULL,NULL,NULL),(14,'CREATE','CLIENT',2,3,2,NULL,NULL,'/clients/template',2,NULL,'{\"staffId\":\"2\",\"firstname\":\"Johnson\",\"lastname\":\"D\",\"active\":true,\"activationDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"groupId\":\"3\",\"officeId\":\"2\"}',1,'2014-03-07 19:56:25',NULL,NULL,1,NULL,NULL,NULL,NULL),(15,'CREATE','CLIENT',2,3,3,NULL,NULL,'/clients/template',3,NULL,'{\"staffId\":\"2\",\"firstname\":\"Williams\",\"lastname\":\"G\",\"active\":false,\"activationDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"groupId\":\"3\",\"officeId\":\"2\"}',1,'2014-03-07 19:57:18',NULL,NULL,1,NULL,NULL,NULL,NULL),(16,'DELETE','CLIENT',2,NULL,3,NULL,NULL,'/clients/3',3,NULL,'{}',1,'2014-03-07 19:59:46',NULL,NULL,1,NULL,NULL,NULL,NULL),(17,'CREATE','CLIENT',2,3,4,NULL,NULL,'/clients/template',4,NULL,'{\"staffId\":\"2\",\"firstname\":\"Williams\",\"lastname\":\"G\",\"active\":true,\"activationDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"groupId\":\"3\",\"officeId\":\"2\"}',1,'2014-03-07 20:00:26',NULL,NULL,1,NULL,NULL,NULL,NULL),(18,'CREATE','CLIENT',2,3,5,NULL,NULL,'/clients/template',5,NULL,'{\"staffId\":\"2\",\"firstname\":\"Harris\",\"lastname\":\"P\",\"active\":true,\"activationDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"groupId\":\"3\",\"officeId\":\"2\"}',1,'2014-03-07 20:01:07',NULL,NULL,1,NULL,NULL,NULL,NULL),(19,'CREATE','CLIENT',2,4,6,NULL,NULL,'/clients/template',6,NULL,'{\"staffId\":\"2\",\"firstname\":\"Allen\",\"lastname\":\"E\",\"active\":true,\"activationDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"groupId\":\"4\",\"officeId\":\"2\"}',1,'2014-03-07 20:02:37',NULL,NULL,1,NULL,NULL,NULL,NULL),(20,'CREATE','CLIENT',2,4,7,NULL,NULL,'/clients/template',7,NULL,'{\"staffId\":\"2\",\"firstname\":\"Allen\",\"lastname\":\"E\",\"active\":true,\"activationDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"groupId\":\"4\",\"officeId\":\"2\"}',1,'2014-03-07 20:02:37',NULL,NULL,1,NULL,NULL,NULL,NULL),(21,'UPDATE','CLIENT',2,NULL,7,NULL,NULL,'/clients/7',7,NULL,'{\"firstname\":\"Scott\",\"lastname\":\"C\"}',1,'2014-03-07 20:04:17',NULL,NULL,1,NULL,NULL,NULL,NULL),(22,'CREATE','CLIENT',2,4,8,NULL,NULL,'/clients/template',8,NULL,'{\"staffId\":\"2\",\"firstname\":\"Robinson\",\"lastname\":\"R\",\"active\":true,\"activationDate\":\"04 January 2010\",\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"groupId\":\"4\",\"officeId\":\"2\"}',1,'2014-03-07 20:05:31',NULL,NULL,1,NULL,NULL,NULL,NULL),(23,'CREATE','OFFICE',3,NULL,NULL,NULL,NULL,'/offices/template',3,NULL,'{\"parentId\":1,\"name\":\"Guaymas\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\",\"openingDate\":\"08 February 2010\"}',1,'2014-03-07 20:06:22',NULL,NULL,1,NULL,NULL,NULL,NULL),(24,'CREATE','USER',1,NULL,NULL,NULL,NULL,'/users/template',5,NULL,'{\"sendPasswordToEmail\":true,\"officeId\":1,\"username\":\"janej\",\"firstname\":\"Jane\",\"lastname\":\"J\",\"email\":\"janej@123.com\",\"roles\":[\"1\"]}',1,'2014-03-07 20:07:48',NULL,NULL,1,NULL,NULL,NULL,NULL),(25,'CREATE','STAFF',3,NULL,NULL,NULL,NULL,'/staff/template',3,NULL,'{\"isLoanOfficer\":true,\"officeId\":3,\"firstname\":\"John\",\"lastname\":\"K\"}',1,'2014-03-07 20:08:28',NULL,NULL,1,NULL,NULL,NULL,NULL),(26,'CREATE','FUND',NULL,NULL,NULL,NULL,NULL,'/funds/template',1,NULL,'{\"name\":\"Loan from Central Bank\"}',1,'2014-03-10 10:11:50',NULL,NULL,1,NULL,NULL,NULL,NULL),(27,'CREATE','LOANPRODUCT',NULL,NULL,NULL,NULL,NULL,'/loanproducts/template',1,NULL,'{\"currencyCode\":\"USD\",\"includeInBorrowerCycle\":\"false\",\"useBorrowerCycle\":\"false\",\"digitsAfterDecimal\":\"2\",\"inMultiplesOf\":\"0\",\"repaymentFrequencyType\":1,\"interestRateFrequencyType\":3,\"amortizationType\":1,\"interestType\":1,\"interestCalculationPeriodType\":1,\"transactionProcessingStrategyId\":1,\"principalVariationsForBorrowerCycle\":[],\"interestRateVariationsForBorrowerCycle\":[],\"numberOfRepaymentVariationsForBorrowerCycle\":[],\"multiDisburseLoan\":false,\"fundSourceAccountId\":31,\"loanPortfolioAccountId\":32,\"transfersInSuspenseAccountId\":33,\"interestOnLoanAccountId\":36,\"incomeFromFeeAccountId\":37,\"incomeFromPenaltyAccountId\":38,\"writeOffAccountId\":41,\"overpaymentLiabilityAccountId\":30,\"accountingRule\":\"2\",\"name\":\"Income Generating Loan\",\"shortName\":\"IGL\",\"fundId\":1,\"minPrincipal\":\"10000\",\"principal\":\"10000\",\"maxPrincipal\":\"10000\",\"minNumberOfRepayments\":\"25\",\"numberOfRepayments\":\"25\",\"maxNumberOfRepayments\":\"25\",\"repaymentEvery\":\"1\",\"minInterestRatePerPeriod\":\"26\",\"interestRatePerPeriod\":\"26\",\"maxInterestRatePerPeriod\":\"26\",\"paymentChannelToFundSourceMappings\":[],\"feeToIncomeAccountMappings\":[],\"penaltyToIncomeAccountMappings\":[],\"charges\":[],\"dateFormat\":\"dd MMMM yyyy\",\"locale\":\"en\",\"startDate\":\"01 January 2010\"}',1,'2014-03-10 10:16:39',NULL,NULL,1,NULL,NULL,NULL,NULL),(28,'CREATE','SAVINGSPRODUCT',NULL,NULL,NULL,NULL,NULL,'/savingsproducts/template',1,NULL,'{\"currencyCode\":\"USD\",\"digitsAfterDecimal\":2,\"interestCompoundingPeriodType\":1,\"interestPostingPeriodType\":4,\"interestCalculationType\":1,\"interestCalculationDaysInYearType\":365,\"savingsReferenceAccountId\":31,\"overdraftPortfolioControlId\":32,\"savingsControlAccountId\":30,\"incomeFromFeeAccountId\":36,\"incomeFromPenaltyAccountId\":37,\"incomeFromInterestId\":38,\"interestOnSavingsAccountId\":41,\"writeOffAccountId\":42,\"accountingRule\":\"2\",\"name\":\"Voluntary savings\",\"shortName\":\"VS\",\"description\":\"Save money\",\"inMultiplesOf\":\"0\",\"nominalAnnualInterestRate\":\"9.5\",\"minRequiredOpeningBalance\":\"1000\",\"lockinPeriodFrequency\":\"1\",\"lockinPeriodFrequencyType\":1,\"withdrawalFeeForTransfers\":\"false\",\"paymentChannelToFundSourceMappings\":[],\"feeToIncomeAccountMappings\":[],\"penaltyToIncomeAccountMappings\":[],\"charges\":[],\"locale\":\"en\",\"transfersInSuspenseAccountId\":30}',1,'2014-03-10 10:21:16',NULL,NULL,1,NULL,NULL,NULL,NULL),(29,'UPDATE','SAVINGSPRODUCT',NULL,NULL,NULL,NULL,NULL,'/savingsproducts/1',1,NULL,'{\"shortName\":\"VS\",\"penaltyToIncomeAccountMappings\":\"[]\",\"paymentChannelToFundSourceMappings\":\"[]\",\"feeToIncomeAccountMappings\":\"[]\"}',1,'2014-03-10 10:21:51',NULL,NULL,1,NULL,NULL,NULL,NULL),(30,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/3/codevalues/template',10,NULL,'{\"name\":\"Cattle Rearing\",\"position\":\"104\"}',1,'2014-03-10 10:27:02',NULL,NULL,1,NULL,NULL,NULL,NULL),(31,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/3/codevalues/template',11,NULL,'{\"name\":\"Others\",\"position\":\"105\"}',1,'2014-03-10 10:27:17',NULL,NULL,1,NULL,NULL,NULL,NULL),(32,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/3/codevalues/template',12,NULL,'{\"name\":\"Tailoring Shop\",\"position\":\"101\"}',1,'2014-03-10 10:27:34',NULL,NULL,1,NULL,NULL,NULL,NULL),(33,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/3/codevalues/template',13,NULL,'{\"name\":\"Small Provisions Store\",\"position\":\"102\"}',1,'2014-03-10 10:27:49',NULL,NULL,1,NULL,NULL,NULL,NULL),(34,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/3/codevalues/template',14,NULL,'{\"name\":\"Agriculture\",\"position\":\"105\"}',1,'2014-03-10 10:28:02',NULL,NULL,1,NULL,NULL,NULL,NULL),(35,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/3/codevalues/14',14,NULL,'{\"position\":103}',1,'2014-03-10 10:28:13',NULL,NULL,1,NULL,NULL,NULL,NULL),(36,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/template',15,NULL,'{\"name\":\"Blacklisted\",\"position\":\"201\"}',1,'2014-03-10 10:31:50',NULL,NULL,1,NULL,NULL,NULL,NULL),(37,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/template',16,NULL,'{\"name\":\"Deceased\",\"position\":\"202\"}',1,'2014-03-10 10:34:54',NULL,NULL,1,NULL,NULL,NULL,NULL),(38,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/template',17,NULL,'{\"name\":\"Transferred\",\"position\":\"203\"}',1,'2014-03-10 10:35:10',NULL,NULL,1,NULL,NULL,NULL,NULL),(39,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/template',18,NULL,'{\"name\":\"Left\",\"position\":\"204\"}',1,'2014-03-10 10:35:23',NULL,NULL,1,NULL,NULL,NULL,NULL),(40,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/template',19,NULL,'{\"position\":\"205\",\"name\":\"others\"}',1,'2014-03-10 10:35:33',NULL,NULL,1,NULL,NULL,NULL,NULL),(41,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/1/codevalues/2',2,NULL,'{\"name\":\"Government Id\"}',1,'2014-03-10 10:37:37',NULL,NULL,1,NULL,NULL,NULL,NULL),(42,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/1/codevalues/1',1,NULL,'{\"name\":\"Passport Id\"}',1,'2014-03-10 10:38:09',NULL,NULL,1,NULL,NULL,NULL,NULL),(43,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/1/codevalues/template',20,NULL,'{\"name\":\"Voter ID\",\"position\":\"7\"}',1,'2014-03-10 10:38:50',NULL,NULL,1,NULL,NULL,NULL,NULL),(44,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/1/codevalues/template',21,NULL,'{\"name\":\"Ration Card\",\"position\":\"6\"}',1,'2014-03-10 10:39:08',NULL,NULL,1,NULL,NULL,NULL,NULL),(45,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/1/codevalues/21',21,NULL,'{\"position\":5}',1,'2014-03-10 10:39:20',NULL,NULL,1,NULL,NULL,NULL,NULL),(46,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/1/codevalues/20',20,NULL,'{\"position\":6}',1,'2014-03-10 10:39:24',NULL,NULL,1,NULL,NULL,NULL,NULL),(47,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/19',19,NULL,'{\"position\":5}',1,'2014-03-10 10:39:53',NULL,NULL,1,NULL,NULL,NULL,NULL),(48,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/18',18,NULL,'{\"position\":4}',1,'2014-03-10 10:39:53',NULL,NULL,1,NULL,NULL,NULL,NULL),(49,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/17',17,NULL,'{\"position\":3}',1,'2014-03-10 10:39:53',NULL,NULL,1,NULL,NULL,NULL,NULL),(50,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/16',16,NULL,'{\"position\":2}',1,'2014-03-10 10:39:54',NULL,NULL,1,NULL,NULL,NULL,NULL),(51,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/14/codevalues/15',15,NULL,'{\"position\":1}',1,'2014-03-10 10:39:54',NULL,NULL,1,NULL,NULL,NULL,NULL),(52,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/4/codevalues/template',22,NULL,'{\"name\":\"Male\",\"position\":\"1\"}',1,'2014-03-10 10:46:36',NULL,NULL,1,NULL,NULL,NULL,NULL),(53,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/4/codevalues/22',22,NULL,'{\"position\":2}',1,'2014-03-10 10:46:49',NULL,NULL,1,NULL,NULL,NULL,NULL),(54,'UPDATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/4/codevalues/22',22,NULL,'{\"position\":1}',1,'2014-03-10 10:47:02',NULL,NULL,1,NULL,NULL,NULL,NULL),(55,'CREATE','CODEVALUE',NULL,NULL,NULL,NULL,NULL,'/codes/4/codevalues/template',24,NULL,'{\"name\":\"Female\",\"position\":\"2\"}',1,'2014-03-10 10:47:20',NULL,NULL,1,NULL,NULL,NULL,NULL),(56,'CREATE','CHARGE',NULL,NULL,NULL,NULL,NULL,'/charges/template',1,NULL,'{\"chargeAppliesTo\":1,\"name\":\"Processing Fee\",\"currencyCode\":\"USD\",\"chargeTimeType\":1,\"chargeCalculationType\":1,\"chargePaymentMode\":0,\"amount\":\"500\",\"active\":true,\"locale\":\"en\",\"monthDayFormat\":\"dd MMM\"}',1,'2014-03-10 10:50:24',NULL,NULL,1,NULL,NULL,NULL,NULL),(57,'UPDATE','LOANPRODUCT',NULL,NULL,NULL,NULL,NULL,'/loanproducts/1',1,NULL,'{\"inMultiplesOf\":0,\"charges\":\"[{\\\"id\\\":1}]\",\"penaltyToIncomeAccountMappings\":\"[]\",\"paymentChannelToFundSourceMappings\":\"[]\",\"feeToIncomeAccountMappings\":\"[]\"}',1,'2014-03-10 10:59:18',NULL,NULL,1,NULL,NULL,NULL,NULL),(58,'UPDATE','USER',3,NULL,NULL,NULL,NULL,'/users/5',5,NULL,'{\"officeId\":3}',1,'2014-03-14 16:22:56',NULL,NULL,1,NULL,NULL,NULL,NULL),(59,'UPDATE','CENTER',2,2,NULL,NULL,NULL,'/centers/2',2,NULL,'{\"name\":\"Santa Maria\"}',1,'2014-03-14 16:50:20',NULL,NULL,1,NULL,NULL,NULL,NULL),(60,'UPDATE','CENTER',2,1,NULL,NULL,NULL,'/centers/1',1,NULL,'{\"name\":\"Santa Cruz\"}',1,'2014-03-14 16:51:55',NULL,NULL,1,NULL,NULL,NULL,NULL),(61,'UPDATE','GROUP',2,3,NULL,NULL,NULL,'/groups/3',3,NULL,'{\"name\":\"Santa Maria Group 1\"}',1,'2014-03-14 16:57:00',NULL,NULL,1,NULL,NULL,NULL,NULL),(62,'UPDATE','GROUP',2,4,NULL,NULL,NULL,'/groups/4',4,NULL,'{\"name\":\"Santa Maria Group 2\"}',1,'2014-03-14 16:57:27',NULL,NULL,1,NULL,NULL,NULL,NULL),(63,'UPDATE','LOANPRODUCT',NULL,NULL,NULL,NULL,NULL,'/loanproducts/1',1,NULL,'{\"inMultiplesOf\":0,\"penaltyToIncomeAccountMappings\":\"[]\",\"incomeFromFeeAccountId\":36,\"fundSourceAccountId\":32,\"paymentChannelToFundSourceMappings\":\"[]\",\"interestOnLoanAccountId\":38,\"transfersInSuspenseAccountId\":31,\"loanPortfolioAccountId\":34,\"incomeFromPenaltyAccountId\":37,\"feeToIncomeAccountMappings\":\"[]\"}',1,'2014-05-01 16:25:00',NULL,NULL,1,NULL,NULL,NULL,NULL),(64,'UPDATE','GLACCOUNT',NULL,NULL,NULL,NULL,NULL,'/glaccounts/17',17,NULL,'{\"usage\":1}',1,'2014-05-01 16:25:26',NULL,NULL,1,NULL,NULL,NULL,NULL),(65,'UPDATE','GLACCOUNT',NULL,NULL,NULL,NULL,NULL,'/glaccounts/2',2,NULL,'{\"usage\":1}',1,'2014-05-01 16:25:56',NULL,NULL,1,NULL,NULL,NULL,NULL),(66,'UPDATE','LOANPRODUCT',NULL,NULL,NULL,NULL,NULL,'/loanproducts/1',1,NULL,'{\"inMultiplesOf\":0,\"penaltyToIncomeAccountMappings\":\"[]\",\"paymentChannelToFundSourceMappings\":\"[]\",\"feeToIncomeAccountMappings\":\"[]\"}',1,'2014-05-01 16:26:06',NULL,NULL,1,NULL,NULL,NULL,NULL),(67,'UPDATE','LOANPRODUCT',NULL,NULL,NULL,NULL,NULL,'/loanproducts/1',1,NULL,'{\"inMultiplesOf\":0,\"overpaymentLiabilityAccountId\":2,\"penaltyToIncomeAccountMappings\":\"[]\",\"paymentChannelToFundSourceMappings\":\"[]\",\"transfersInSuspenseAccountId\":17,\"feeToIncomeAccountMappings\":\"[]\"}',1,'2014-05-01 16:26:37',NULL,NULL,1,NULL,NULL,NULL,NULL),(68,'CREATE','LOAN',2,NULL,8,1,NULL,'/loans',1,NULL,'{\"clientId\":\"8\",\"productId\":1,\"disbursementData\":[],\"fundId\":1,\"principal\":10000,\"loanTermFrequency\":25,\"loanTermFrequencyType\":1,\"numberOfRepayments\":25,\"repaymentEvery\":1,\"repaymentFrequencyType\":1,\"interestRatePerPeriod\":26,\"amortizationType\":1,\"interestType\":1,\"interestCalculationPeriodType\":1,\"transactionProcessingStrategyId\":1,\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\",\"loanType\":\"individual\",\"expectedDisbursementDate\":\"16 June 2014\",\"submittedOnDate\":\"02 June 2014\",\"charges\":[{\"chargeId\":1,\"amount\":500}]}',1,'2014-06-11 09:17:45',NULL,NULL,1,NULL,NULL,NULL,NULL),(69,'APPROVE','LOAN',2,NULL,8,1,NULL,'/loans/1',1,NULL,'{\"status\":{\"id\":200,\"code\":\"loanStatusType.approved\",\"value\":\"Approved\",\"pendingApproval\":false,\"waitingForDisbursal\":true,\"active\":false,\"closedObligationsMet\":false,\"closedWrittenOff\":false,\"closedRescheduled\":false,\"closed\":false,\"overpaid\":false},\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\",\"approvedOnDate\":\"11 June 2014\"}',1,'2014-06-11 09:18:16',NULL,NULL,1,NULL,NULL,NULL,NULL),(70,'CREATE','FINANCIALACTIVITYACCOUNT',NULL,NULL,NULL,NULL,NULL,'/organizationglaccounts/template',2,NULL,'{\"financialActivityId\":100,\"glAccountId\":33}',1,'2014-06-16 16:54:20',NULL,NULL,1,NULL,NULL,NULL,NULL),(71,'UPDATE','FINANCIALACTIVITYACCOUNT',NULL,NULL,NULL,NULL,NULL,'/organizationglaccounts/2',2,NULL,'{\"glAccountId\":32}',1,'2014-06-16 16:57:17',NULL,NULL,1,NULL,NULL,NULL,NULL),(72,'DELETE','FINANCIALACTIVITYACCOUNT',NULL,NULL,NULL,NULL,NULL,'/organizationglaccounts/2',2,NULL,'{}',1,'2014-06-16 17:11:12',NULL,NULL,1,NULL,NULL,NULL,NULL),(73,'CREATE','DATATABLE',NULL,NULL,NULL,NULL,NULL,'/datatables/',NULL,NULL,'{\"datatableName\":\"Client Profile\",\"apptableName\":\"m_client\",\"multiRow\":false,\"columns\":[{\"name\":\"married\",\"type\":\"Boolean\",\"mandatory\":false},{\"name\":\"no_of_children\",\"type\":\"Number\",\"mandatory\":false}]}',1,'2019-04-08 11:49:49',NULL,NULL,1,NULL,NULL,NULL,NULL),(74,'CREATE','DATATABLE',NULL,NULL,NULL,NULL,NULL,'/datatables/',NULL,NULL,'{\"datatableName\":\"Client Laptops\",\"multiRow\":true,\"apptableName\":\"m_client\",\"columns\":[{\"name\":\"model\",\"type\":\"String\",\"mandatory\":false,\"length\":\"30\"},{\"name\":\"serial_no\",\"type\":\"String\",\"mandatory\":false,\"length\":\"50\"}]}',1,'2019-04-08 11:51:06',NULL,NULL,1,NULL,NULL,NULL,NULL),(75,'CREATE','Client Profile',1,NULL,1,NULL,NULL,'/datatables/Client Profile/1',1,NULL,'{\"married\":\"true\",\"no_of_children\":\"2\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2019-04-08 12:06:30',NULL,NULL,1,NULL,NULL,NULL,NULL),(76,'CREATE','Client Laptops',1,NULL,1,NULL,NULL,'/datatables/Client Laptops/1',1,NULL,'{\"model\":\"HP Elitebook 8740w\",\"serial_no\":\"ASDFO903R2\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2019-04-08 12:06:49',NULL,NULL,1,NULL,NULL,NULL,NULL),(77,'CREATE','Client Laptops',1,NULL,1,NULL,NULL,'/datatables/Client Laptops/1',1,NULL,'{\"model\":\"MacBook Pro 2018\",\"serial_no\":\"OI9U98SDFSDF\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2019-04-08 12:07:04',NULL,NULL,1,NULL,NULL,NULL,NULL),(78,'CREATE','Client Profile',2,NULL,2,NULL,NULL,'/datatables/Client Profile/2',2,NULL,'{\"married\":\"false\",\"no_of_children\":\"0\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2019-04-08 12:07:17',NULL,NULL,1,NULL,NULL,NULL,NULL),(79,'CREATE','Client Laptops',2,NULL,2,NULL,NULL,'/datatables/Client Laptops/2',2,NULL,'{\"model\":\"Lenove Thinkpad T430\",\"serial_no\":\"POD98DFSFSDF\",\"locale\":\"en\",\"dateFormat\":\"dd MMMM yyyy\"}',1,'2019-04-08 12:07:43',NULL,NULL,1,NULL,NULL,NULL,NULL);
...
INSERT INTO `m_product_loan` VALUES (1,'IGL','USD',2,0,10000.000000,10000.000000,10000.000000,NULL,'Income Generating Loan',NULL,1,'\0','\0',26.000000,26.000000,26.000000,3,26.000000,1,1,0,1,1,25,25,25,NULL,NULL,NULL,NULL,1,2,1,NULL,0,0,'2010-01-01',NULL,0,NULL,NULL,NULL,NULL,1,1,0,NULL,0,0.00,0,0,NULL,0,0);
...
INSERT INTO `m_savings_product` VALUES (1,'Voluntary savings','VS','Save money',100,'USD',2,0,9.500000,1,4,1,365,1000.000000,1.000000,1,2,NULL,NULL,0,0,NULL,0.000000,0.000000,NULL,0,NULL,0,NULL,NULL,NULL,NULL,NULL);
...
INSERT INTO `x_registered_table` VALUES ('Client Laptops','m_client',100),('Client Profile','m_client',100);
...
-- Dump completed on 2019-04-08 12:08:20
